...
export interface TowerlordsCardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "cardDefinitionIdOf",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface TowerlordsCards extends BaseContract {
  connect(runner?: ContractRunner | null): TowerlordsCards;
  waitForDeployment(): Promise<this>;

  interface: TowerlordsCardsInterface;
  ...
  cardDefinitionIdOf: TypedContractMethod<
    [tokenId: BigNumberish],
    [string],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "cardDefinitionIdOf"
